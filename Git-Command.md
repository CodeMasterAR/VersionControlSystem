...
## Create Repository
  ...
  - **git init** <p>command creates local repository in your desktop in Version_Control_System folder.</p>
...
## Syncing Repository
  ...
  - <p>If you found error like below: </p>
    <img src = "https://github.com/CodeMasterAR/VersionControlSystem/assets/114680435/b7fd67e2-1aa2-4719-ab2f-fbbea5e06050" width = "900" height = "70"/>
    
    **git remote -v**. <p>Using this command you can check the already exists url</p>
